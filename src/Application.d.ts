 ...
 */
export declare function createUser(appID: string, auth: ApplicationIdentityAuth, secret: string | Uint8Array): Promise<wallix.gopeps.protobuf.datapeps.RegisterApplicationIdentityResponse>;
