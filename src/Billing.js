                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, HTTP_1.client.doRequest({
                            ...
                            body: billing.GetTenantBillRequest.encode({
                                ...
                                period: new proto_1.wallix.gopeps.protobuf.common.Duration({
                                    start: period.from,
                                    end: period.to
                                }),
                    ...
                    case 1:
                        ...
                        if (response.body.bill != "simpleBill") {
                            throw new Error_1.Error({
                                ...
                                message: "a bill of the kind \"" + response.body.bill + "\", a bill of the kind \"simpleBill\" was expected"
                            });
                        }
                        bill = response.body.simpleBill;
