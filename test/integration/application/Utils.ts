...
const HSKey = new TextEncoder().encode("aVerySecretKey");
const RSKey = new TextEncoder().encode(
...
const RSSecretKey = new TextEncoder().encode(
...
const ESKey = new TextEncoder().encode(
...
const ESSecretKey = new TextEncoder().encode(
